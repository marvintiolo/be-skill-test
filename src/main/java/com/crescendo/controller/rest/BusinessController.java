...
public class BusinessController {
	...
	public ResponseEntity<List<Business>> getAllBusinesses() {
		return new ResponseEntity<>(
				businessService.getAllBusiness(), HttpStatus.OK);
	}
	
	@GetMapping("/businesses/{id}")
	public ResponseEntity<Business> getBusinessById(@PathVariable int id) {
		return new ResponseEntity<>(
				businessService.getBusinessById(id), HttpStatus.OK);
	}
	
	@PostMapping("/businesses")
	public ResponseEntity<Business> createBusiness(@RequestBody Business business) {
		return new ResponseEntity<>(
				businessService.addBusiness(business), HttpStatus.CREATED);
	}
	
	@PutMapping("/businesses/{id}")
	public ResponseEntity<Business> updateBusiness(@RequestBody Business business, @PathVariable int id) {
		return new ResponseEntity<>(
				businessService.updateBusiness(business, id), HttpStatus.OK);
	}
